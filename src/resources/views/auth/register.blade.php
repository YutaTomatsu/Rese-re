...
<main class="main">
        ...
        <form class="form" method="POST" action="{{ route('register') }}">
            ...
            <div class="line">
                ...
                <x-jet-input id="name" class="item" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Name"/>
            </div>

            <div class="line">
                <img class="img" src="img/email.png" alt="Email">
                <x-jet-input id="email" class="item" type="email" name="email" :value="old('email')" required placeholder="Email"/>
            </div>

            <div class="line">
                <img class="img" src="img/password.png" alt="Password">
                <x-jet-input id="password" class="item" type="password" name="password" required autocomplete="new-password" placeholder="Password"/>
            </div>

            <div class="line">
                <x-jet-input id="password_confirmation" class="item confirm" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Password-Confirm"/>
            </div>
