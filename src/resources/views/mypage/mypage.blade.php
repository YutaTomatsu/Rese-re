                        ...
                        <div class="confirm">
                            <div class="reserve__item__top">
                                ...
                                <div class="reserve__right">
                                    <a class="reserve__qr"
                                        href="{{ route('reserve-qr', ['id' => $reservation->id]) }}">qrを表示</a>
                                    <a class="reserve__edit"
                                        href="{{ route('edit', ['id' => $reservation->id]) }}">予約の編集</a>

                                    <a class="reserve__delete" href="{{ route('delete', ['id' => $reservation->id]) }}"
                                        onclick="return confirm('本当に予約を削除しますか？')"><img class="delete__img"
                                            src="/img/reserve_delete.svg" alt="delete"></a>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="under__box">
                                <div class="under__item">
                                    ...
                                    <div class="between">
                                        <a class="detail"
                                            href="{{ route('detail', ['id' => $shop->shop_id]) }}">詳しく見る</a>
                                        <div class="between__right">

                                            @if (Auth::check())
                                                @if (in_array($shop->shop_id, $favorite_shops))
                                                    <div class="heart">
                                                        <img class="toggle_img" src="{{ asset('img/redheart.svg') }}"
                                                            alt="heart" data-shopid="{{ $shop->shop_id }}"
                                                            data-userid="{{ Auth::id() }}">
                                                    </div>
                                                @else
                                                    <div class="heart">
                                                        <img class="toggle_img"
                                                            src="{{ asset('img/grayheart.svg') }}" alt="heart"
